...
# class User:
#     # basic properties of a user as variable
#     def __init__(self, name, email, password, pno, age):
#         self.name = name
#         self.email = email
#         self.age = age
#         self.pno = pno
...
# Movie class
# class Movies:
#     def __init__(self, title, genre, length, cast, director, rating, language, show_timings, capacity):
#         self.title = title
#         self.length = length
#         self.cast = cast
...
#
#
# movie_1 = Movies('Lorem', 'Horror', '1hr 20 mins', 'John Doe', 'Moon Fards', '5/10', 'English', '8-10,12-2,6-8', '50')
